...
function getEmoticonScores ( emoticons ) {
    ...
    if ( !emoticons ) {
        return {
            emoticon_greaterZero: 0,
            emoticon_totalScore: 0,
            emoticon_maxScore: 0,
            emoticon_lastToken: 0
        };
    }
    ...
    var output = {
        ...
        emoticon_totalScore: scores.reduce( (a, b) => a + b) || 0,
        emoticon_maxScore: scores.max() || 0,
...
module.exports = exports = getFeatures;
